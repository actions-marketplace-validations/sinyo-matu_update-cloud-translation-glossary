...
const node_fetch_1 = __importDefault(__nccwpck_require3_(429));
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __nccwpck_require3_(267),
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __nccwpck_require3_(742)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __nccwpck_require3_(477))
    ...
    Object.assign(globalThis, __nccwpck_require3_(452))
  }
}
...
try {
  ...
  const { Blob } = __nccwpck_require3_(300)
...
"use strict";
/* harmony export */ __nccwpck_require3_.d(__webpack_exports__, {
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(410);
...
var node_domexception = __nccwpck_require3_(760);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require3_(213);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require3_(410);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(572);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(410);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require3_(213);
...
const external_node_http_namespaceObject = __nccwpck_require2_(849);
;// CONCATENATED MODULE: external "node:https"
const external_node_https_namespaceObject = __nccwpck_require2_(286);
;// CONCATENATED MODULE: external "node:zlib"
const external_node_zlib_namespaceObject = __nccwpck_require2_(628);
;// CONCATENATED MODULE: external "node:stream"
const external_node_stream_namespaceObject = __nccwpck_require2_(492);
;// CONCATENATED MODULE: external "node:buffer"
const external_node_buffer_namespaceObject = __nccwpck_require2_(254);
...
const external_node_util_namespaceObject = __nccwpck_require2_(261);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require3_(410);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __nccwpck_require3_(10);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require3_.e(/* import() */ 37).then(__nccwpck_require3_.bind(__nccwpck_require3_, 152));
...
const external_node_url_namespaceObject = __nccwpck_require2_(41);
...
const external_node_net_namespaceObject = __nccwpck_require2_(503);
...
var from = __nccwpck_require3_(777);
...
/******/ 	__nccwpck_require3_.m = __webpack_modules__;
/******/ 	
/************************************************************************/
...
/******/ 	(() => {
/******/ 		__nccwpck_require3_.f = {};
/******/ 		// This file contains only the entry chunk.
/******/ 		// The chunk loading function for additional chunks
/******/ 		__nccwpck_require3_.e = (chunkId) => {
/******/ 			return Promise.all(Object.keys(__nccwpck_require3_.f).reduce((promises, key) => {
/******/ 				__nccwpck_require3_.f[key](chunkId, promises);
/******/ 				return promises;
/******/ 			}, []));
/******/ 		};
/******/ 	})();
...
/******/ 				if(__nccwpck_require3_.o(moreModules, moduleId)) {
/******/ 					__nccwpck_require3_.m[moduleId] = moreModules[moduleId];
/******/ 				}
/******/ 			}
/******/ 			if(runtime) runtime(__nccwpck_require3_);
...
/******/ 		__nccwpck_require3_.f.require = (chunkId, promises) => {
/******/ 			// "1" is the signal for "already loaded"
/******/ 			if(!installedChunks[chunkId]) {
/******/ 				if(true) { // all chunks have JS
/******/ 					installChunk(require("./" + __nccwpck_require3_.u(chunkId)));
/******/ 				} else {}
/******/ 			}
/******/ 		};
/******/ 		
