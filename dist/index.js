...
const node_fetch_1 = __importDefault(__nccwpck_require6_(429));
...
function onePairInput(sourceLanguage, targetLanguage) {
    return __awaiter(this, void 0, void 0, function* () {
        const { bucketName, glossaryFileName, projectId, glossaryName, accessToken } = getRequiredInputs();
        yield deleteGlossary(projectId, glossaryName, accessToken);
        ...
        yield createGlossary(input, projectId, accessToken);
    });
}
function codesSetInput(codesSet) {
    return __awaiter(this, void 0, void 0, function* () {
        const { bucketName, glossaryFileName, projectId, glossaryName, accessToken } = getRequiredInputs();
        yield deleteGlossary(projectId, glossaryName, accessToken);
        const glossaryFullName = `projects/${projectId}/locations/us-central1/glossaries/${glossaryName}`;
...
function createGlossary(input, projectId, accessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (resp.status >= 300) {
            core.error(`delete glossary request failed with status:${resp.status} message:${resp.text}`);
            throw Error("delete request failed");
        }
        return;
    });
}
function deleteGlossary(projectId, glossaryName, accessToken) {
    return __awaiter(this, void 0, void 0, function* () {
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const languageCodesSet = core.getInput("language-codes-set", notRequiredInputOption);
        if (targetLanguage.length !== 0 && sourceLanguage.length !== 0) {
            ...
            yield onePairInput(targetLanguage, sourceLanguage);
            return;
        }
        if (languageCodesSet.length !== 0) {
            ...
            yield codesSetInput(languageCodesSet);
            return;
        }
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __nccwpck_require6_(267),
...
"use strict";
module.exports = __nccwpck_require5_(742);
...
/***/ 572:
/***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require6_) => {
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __nccwpck_require6_(742)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __nccwpck_require6_(477))
    ...
    Object.assign(globalThis, __nccwpck_require6_(452))
  }
}
...
try {
  ...
  const { Blob } = __nccwpck_require6_(300)
...
/***/ 213:
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __nccwpck_require6_) => {

"use strict";
/* harmony export */ __nccwpck_require6_.d(__webpack_exports__, {
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require6_(410);
...
// EXPORTS
__nccwpck_require6_.d(__webpack_exports__, {
...
const external_node_fs_namespaceObject = __nccwpck_require5_(561);
;// CONCATENATED MODULE: external "node:path"
const external_node_path_namespaceObject = __nccwpck_require5_(411);
// EXTERNAL MODULE: ./node_modules/node-domexception/index.js
var node_domexception = __nccwpck_require6_(760);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require6_(213);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require6_(410);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require6_(572);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require6_(410);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require6_(213);
...
"use strict";
// ESM COMPAT FLAG
__nccwpck_require6_.r(__webpack_exports__);
...
const external_node_http_namespaceObject = __nccwpck_require5_(849);
;// CONCATENATED MODULE: external "node:https"
const external_node_https_namespaceObject = __nccwpck_require5_(286);
;// CONCATENATED MODULE: external "node:zlib"
const external_node_zlib_namespaceObject = __nccwpck_require5_(628);
;// CONCATENATED MODULE: external "node:stream"
const external_node_stream_namespaceObject = __nccwpck_require5_(492);
;// CONCATENATED MODULE: external "node:buffer"
const external_node_buffer_namespaceObject = __nccwpck_require5_(254);
...
const external_node_util_namespaceObject = __nccwpck_require5_(261);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require6_(410);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __nccwpck_require6_(10);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require6_.e(/* import() */ 37).then(__nccwpck_require6_.bind(__nccwpck_require6_, 152));
...
const external_node_url_namespaceObject = __nccwpck_require5_(41);
...
const external_node_net_namespaceObject = __nccwpck_require5_(503);
...
var from = __nccwpck_require6_(777);
...
/******/ 	__nccwpck_require6_.m = __webpack_modules__;
/******/ 	
/************************************************************************/
/******/ 	/* webpack/runtime/define property getters */
/******/ 	(() => {
/******/ 		// define getter functions for harmony exports
/******/ 		__nccwpck_require6_.d = (exports, definition) => {
/******/ 			for(var key in definition) {
/******/ 				if(__nccwpck_require6_.o(definition, key) && !__nccwpck_require6_.o(exports, key)) {
...
/******/ 	(() => {
/******/ 		__nccwpck_require6_.f = {};
/******/ 		// This file contains only the entry chunk.
/******/ 		// The chunk loading function for additional chunks
/******/ 		__nccwpck_require6_.e = (chunkId) => {
/******/ 			return Promise.all(Object.keys(__nccwpck_require6_.f).reduce((promises, key) => {
/******/ 				__nccwpck_require6_.f[key](chunkId, promises);
/******/ 				return promises;
/******/ 			}, []));
/******/ 		};
/******/ 	})();
...
/******/ 	(() => {
/******/ 		__nccwpck_require6_.o = (obj, prop) => (Object.prototype.hasOwnProperty.call(obj, prop))
/******/ 	})();
/******/ 	
/******/ 	/* webpack/runtime/make namespace object */
/******/ 	(() => {
/******/ 		// define __esModule on exports
/******/ 		__nccwpck_require6_.r = (exports) => {
...
/******/ 				if(__nccwpck_require6_.o(moreModules, moduleId)) {
/******/ 					__nccwpck_require6_.m[moduleId] = moreModules[moduleId];
/******/ 				}
/******/ 			}
/******/ 			if(runtime) runtime(__nccwpck_require6_);
...
/******/ 		__nccwpck_require6_.f.require = (chunkId, promises) => {
/******/ 			// "1" is the signal for "already loaded"
/******/ 			if(!installedChunks[chunkId]) {
/******/ 				if(true) { // all chunks have JS
/******/ 					installChunk(require("./" + __nccwpck_require6_.u(chunkId)));
/******/ 				} else {}
/******/ 			}
/******/ 		};
/******/ 		
...
"use strict";
module.exports = __nccwpck_require4_(254);
...
"use strict";
module.exports = __nccwpck_require4_(561);
...
"use strict";
module.exports = __nccwpck_require4_(849);
...
"use strict";
module.exports = __nccwpck_require4_(286);
...
"use strict";
module.exports = __nccwpck_require4_(503);
...
"use strict";
module.exports = __nccwpck_require4_(411);
...
"use strict";
module.exports = __nccwpck_require4_(742);
...
"use strict";
module.exports = __nccwpck_require4_(41);
...
"use strict";
module.exports = __nccwpck_require4_(628);
...
"use strict";
module.exports = __nccwpck_require3_(254);
...
"use strict";
module.exports = __nccwpck_require3_(849);
...
"use strict";
module.exports = __nccwpck_require3_(286);
...
"use strict";
module.exports = __nccwpck_require3_(503);
...
"use strict";
module.exports = __nccwpck_require3_(628);
...
"use strict";
module.exports = __nccwpck_require2_(254);
...
"use strict";
module.exports = __nccwpck_require2_(849);
...
"use strict";
module.exports = __nccwpck_require2_(286);
...
"use strict";
module.exports = __nccwpck_require2_(503);
...
"use strict";
module.exports = __nccwpck_require2_(628);
